...
function install_screen.box(color, color2, color3, x, y, sizeX, sizeY, config)
...
function install_screen.background(color, color2, color3, config)
...
function install_screen.title(textColor)
...
function install_screen.progress(p, config)
